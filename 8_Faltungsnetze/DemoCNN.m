...
layers = [imageInputLayer([imSize, imSize, 1])
   fullyConnectedLayer(H, 'Name', 'Schicht1')
   reluLayer
...
fprintf('trainErr = %.2f%%, testErr = %.2f%%\n', 100*trainErr, 100*testErr);
...
testDs = shuffle(imageDatastore(fullfile('..', 'Daten', 'Cifar10Subset', 'test'), ...
   'IncludeSubfolders',true, 'LabelSource','foldernames'));
trainDs = shuffle(imageDatastore(fullfile('..', 'Daten', 'Cifar10Subset', 'train'), ...
   'IncludeSubfolders',true, 'LabelSource','foldernames'));
...
layers = [imageInputLayer([imgSize, imgSize, 3])
